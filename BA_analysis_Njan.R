...
int_s <- c(rep('sil',5),rep('20dB',10),rep('25dB',10),rep('30dB',10),rep('35dB',10),rep('40dB',10),rep('45dB',10),rep('50dB',10),rep('55dB',10),rep('60dB',10),rep('65dB',10),rep('70dB',10),rep('75dB',10),rep('80dB',10),rep('85dB',10),rep('90dB',10), rep('NA',5))
...
int <- rep(int_s, dim(BA_njan)[1]/160)
...
BA_njan_35 <- BA_njan_int[which(BA_njan_int$freq == 35 & BA_njan_int$ID == 'Njan_016'),]

ggplot(BA_njan_35, aes(as.factor(windows_perint),RMS_dB, group = int, colour = int)) + geom_line() + scale_colour_manual(values=c(marker$color)) + ylim(-75,-60)
